                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="{{$complaint->user_name}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="{{$complaint->phone}}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" value="{{$complaint->email}}" disabled>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                        <form action="{{route('admin.complaint.replay' , ['id' => $complaint->id])}}" method="POST" enctype="multipart/form-data" class="notify-form">
                            @csrf
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    <label for="first-name-column">{{awtTrans('الرد')}}</label>
                                    <div class="controls">
