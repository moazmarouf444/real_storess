                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="body_ar" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="body_en" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="user_type" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" class="select2 form-control" >
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="body" class="form-control" cols="30" rows="10" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label for="first-name-column">{{awtTrans('ارسال الي ')}}</label>
                                        <div class="controls">
                                            <select name="user_type" class="select2 form-control" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                                <option value>{{awtTrans('اختر الفئه المرسل اليها')}}</option>
                                                <option  value="admins">{{awtTrans('المشرفين')}}</option>
                                                <option  value="all_users">{{awtTrans('كل المستخدمين')}}</option>
                                                <option  value="active_users">{{awtTrans('المتسخدمين النشطين')}}</option>
