...
@section('content')
        <div class="row">
                    ...
                    <div class="card-content">
                        <div class="card-body text-center">
                            ...
                            <div class="text-center">
                                <h1 class="mb-2 ">{{awtTrans('مرحبا بك  ')}} {{auth('admin')->user()->name}}</h1>
                                <p style="color: black" class="m-auto w-75">{{  date('d-m-Y', strtotime(\Carbon\Carbon::now())) }} </p>
                                <p style="color: black" class="m-auto w-75">{{  date('h:i A', strtotime(\Carbon\Carbon::now())) }} </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-6 weatherWidgetInner">
                <a class="weatherwidget-io" href="https://forecast7.com/{{lang()}}/24d7146d68/riyadh/" data-label_1="{{awtTRans('RIYADH')}}" data-label_2="{{awtTrans('الطقس')}}" data-font="en-us"  data-icons="Climacons" data-theme="original" data-basecolor="rgb(16 22 58)" ></a>
            </div>
        </div>
        ...
        <div class="row hight-card">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-end">
                        <h4 class="card-title">{{awtTrans('حالات المشاريع')}}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body pb-0">
