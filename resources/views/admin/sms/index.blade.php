                                ...
                                <div class="sms">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$sms->sender_name}}" name="sender_name" class="form-control" placeholder="{{awtTrans('اكتب اسم المرسل')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$sms->user_name}}" name="user_name" class="form-control" placeholder="{{awtTrans('اكتب اسم المستخدم')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" value="{{$sms->password}}" name="password" class="form-control" placeholder="{{awtTrans('اكتب كلمة السر ')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
