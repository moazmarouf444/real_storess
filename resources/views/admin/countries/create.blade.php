        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{awtTrans('اضافه دوله ')}}</h4>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="key" class="form-control" placeholder="{{awtTrans('اكتب كود الدولة')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" data-validation-number-message="{{awtTrans('مسموح بالارقام فقط')}}" >
                                            </div>
                                        </div>
                                    </div>
