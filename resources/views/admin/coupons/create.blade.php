                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="coupon_num" class="form-control" placeholder="{{awtTrans('اكتب رقم الكوبون')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="max_use" class="form-control" placeholder="{{awtTrans('اكتب عدد مرات الاستخدام')}}" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="type" class="select2 form-control type" required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input  type="date" name="expire_date" class="form-control"  required data-validation-required-message="{{awtTrans('هذا الحقل مطلوب')}}" >
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).on('keyup','.discount', function () {
            if ($('.select2').val() == 'number') {
                ...
                if ($(this).val() > 100) {
                    $(this).val(null)
                    toastr.error('{{awtTrans("لايمكن ان تكون النسبة اكبر من 100")}}')
                }
