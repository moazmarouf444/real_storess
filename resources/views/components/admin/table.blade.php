    ...
    <div class="row mt-2 mb-2">
        @isset($order)
            <div class="col-md-3 mt-1 col-12">
                <label for="first-name-column">{{awtTrans('ترتيب حسب')}}</label>
                <div class="controls border">
                    ...
                    <select name="order" class="form-control search-input">
                        ...
                        <option value="ASC">{{awtTrans('تصاعدي')}}</option>
                        <option value="DESC" selected>{{awtTrans('تنازلي')}}</option>
                    </select>
                </div>
            </div>
        @endisset
        @isset($datefilter)
            <div class="col-md-3 mt-1 col-12">
                <label for="first-name-column">{{awtTrans('بداية التاريخ')}}</label>
                <div class="controls border">
                    <i class="fa fa-times clean-input"></i>
            ...
            <div class="col-md-3 mt-1 col-12">
                <label for="first-name-column">{{awtTrans('نهاية التاريخ')}}</label>
                <div class="controls border">
                    <i class="fa fa-times clean-input"></i>
